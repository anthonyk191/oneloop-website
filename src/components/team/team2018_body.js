...
const Team2018_body = () =>{
	return(
		<React.Fragment>
			<div className="oneloop-team2018-body">
				<div className="oneloop-team2018-title">
					<h1>2018-2019 Team</h1>
				</div>

				<h2>Propulsion</h2>
				<div className="oneloop-team2018 propulsion team-mobile">
				...
				<div className="oneloop-team2018 propulsion team-web">
					<div className="propulsion-row row row-1">
						<div className="team-member">
							<img className="team-member" src="/images/team/20182019/Austin_Gonzalez.jpg"/>
							<h4>AUSTIN GONZALEZ<br/>
				...
				<h2>Structures</h2>
				<div className="oneloop-team2018 structures team-mobile">
				...
				<div className="oneloop-team2018 structures team-web">
					<div className="structures-row row row-1">
						<div className="team-member">
							<img className="team-member" src="/images/team/20182019/Simon_Chang.jpg"/>
							<h4>SIMON CHANG<br/>
				...
				<h2>Brakes</h2>
				<div className="oneloop-team2018 brakes team-mobile">
				...
				<div className="oneloop-team2018 brakes team-web">
					<div className="brakes-row row row-1">
						<div className="team-member">
							<img className="team-member" src="/images/team/20182019/Jonathan_Summer.jpg"/>
							<h4>JONATHAN SUMMER<br/>
				...
				<h2>Suspension</h2>
				<div className="oneloop-team2018 suspension team-mobile-1">
					<div className="suspension-row row row-1">
						<div className="team-member">
				...
				<h2>Controls</h2>
				<div className="oneloop-team2018 controls team-mobile">
				...
				<div className="oneloop-team2018 controls team-web">
					<div className="controls-row row row-1">
						<div className="team-member">
							<img className="team-member" src="/images/team/20182019/Kareem_K_Mohammed.jpg"/>
							<h4>KAREEM K. MOHAMMED<br/>
				...
				<h2>Business</h2>
				<div className="oneloop-team2018 business team-mobile">
				...
				<div className="oneloop-team2018 business team-web">
					<div className="business-row row row-1">
						<div className="team-member">
							<img className="team-member" src="/images/team/20182019/Samarth_Sandeep.jpg"/>
							<h4>SAMARTH SANDEEP<br/>
				...
				<h2>Power</h2>
				<div className="oneloop-team2018 power team-mobile-1">
				...
				<h2>Linear Induction Motor Research</h2>
				<div className="oneloop-team2018 Linear-Induction-Motor-Research team-mobile">
					<div className="Linear-Induction-Motor-Research-row row row-1">
						<div className="team-member">
				...
				<div className="oneloop-team2018 Linear-Induction-Motor-Research team-web">
					<div className="Linear-Induction-Motor-Research-row row row-1">
						<div className="team-member">
							<img className="team-member" src="/images/team/20182019/Kevin_Li.jpg"/>
							<h4>KEVIN LI<br/>
				...
				<p>
				Members who are no longer with team:<br/>
				Billy Mazotti, Jackson Liao, Michael Li, Christophe Hiltebrandt McIntosh, 
				Torin Keenan, Madhusha Goonesekera, and Mynor Andres Juan
				</p>
				<div className="team2018-to-team2019">
					<a href="/team2019">Next Year</a>
				</div>
			</div>
		</React.Fragment>
	);
